use bevy::prelude::*;
use crate::AppState;
use crate::menu::{back_to_game, cleanup_menu, SLOW_BLINKING};
...
pub fn setup_end_menu_p1(mut commands: Commands, textures: Res<MenuTextures>) {
    spawn_main_image(&mut commands, textures.win1_1.clone(),
                     false, SLOW_BLINKING);
    spawn_main_image(&mut commands, textures.win1_2.clone(),
                     true, SLOW_BLINKING)
}
